const slides = ['slide647', 'slide648', 'slide649', 'slide650', 'slide651', 'slide652', 'slide653']

$(document).ready(function () {
	// modal
	$('.openModal').on('click', () => {
		$('.modal').css('display', 'block')
		localStorage.setItem('slide647', 'true')
	...
	$('.openModal1').on('click', () => {
        ...
        localStorage.setItem('slide648', 'true')
	...
	$('.openModal2').on('click', () => {
        ...
        localStorage.setItem('slide649', 'true')
	...
	$('.openModal3').on('click', () => {
        ...
        localStorage.setItem('slide650', 'true')
	...
	$('.openModal4').on('click', () => {
        ...
        localStorage.setItem('slide651', 'true')
	...
	$('.openModal5').on('click', () => {
        ...
        localStorage.setItem('slide652', 'true')
	...
	$('.openModal6').on('click', () => {
        ...
        localStorage.setItem('slide653', 'true')
